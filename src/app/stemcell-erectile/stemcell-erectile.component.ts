...
@Component({
  selector: 'app-stemcell-erectile',
  templateUrl: './stemcell-erectile.component.html',
  styleUrls: ['./stemcell-erectile.component.css']
})
export class STEMCELLERECTILEComponent {
   testimonials = [
    {
